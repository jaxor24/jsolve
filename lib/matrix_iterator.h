...
class MatrixIterator
{
  public:
    ...
    using base_iterator_t =
        typename std::conditional_t<std::is_const<T>::value, typename std::vector<value_type_no_const>::const_iterator,
...
class RowEnumerator
{
  public:
    ...
    auto operator*() const
    {
        ...
        return std::make_tuple(m_counter,
                               IterableWrapper<col_iterator_t>{make_iterator<It, col_iterator_t>(m_iterator),
...
class ColEnumerator
{
  public:
    ...
    auto operator*() const
    {
        ...
        return std::make_tuple(m_counter,
                               IterableWrapper<row_iterator_t>{make_iterator<It, row_iterator_t>(m_iterator),
